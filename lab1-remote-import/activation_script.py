...
# До задания *** здесь было: sys.path_hooks.append(url_hook)
# Теперь регистрируется url_package_hook — см. в конце файла.


# ============================================================================
#  Задание *** — импорт пакетов (и пакетов в пакете). Сделано Claude.
#
#  Было: URLFinder находил только файлы name.py.
#  Стало: URLPackageFinder находит ещё и пакеты — папки с __init__.py.
#  Код выше не менялся. Подробно — в README, раздел «Обработка пакетов».
# ============================================================================
